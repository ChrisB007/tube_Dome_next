              ...
              <div className="m-4">
                  {Object.values(providers).map((provider) => {
                    if (provider.name === "Email"){               
                      ...
                      return (< GoogleLoginButton onClick={() => signIn(provider.id)} />)
                    ...
                    return(
                      <div className="w-full" key={provider.name}>
                        <div>
                        <button className="provider-button w-6/12 justify-center items-center px-4 m-4  h-14" onClick={() => signIn(provider.id)}>
